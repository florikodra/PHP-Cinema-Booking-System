...
<?php $kliente=mysql_query("select * from klient where klient_id = '$usid'")or die (mysql_error());
                
                while($knt=mysql_fetch_array($kliente)){ 
                $klmeml = $knt['klient_email'];?>
            ...
            <div class="container">
                <div class="col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                    <form id='contact-form' class="form row" method='post'>
                        ...
                        <div class="col-sm-6">
                            <input type='text' placeholder='Emri Juaj' name='name' class="form__name" value="<?php echo $knt['klient_emer'];?>" readonly>
                        </div>
                        <div class="col-sm-6">
                            <input type='email' placeholder='Emaili Juaj' name='email' class="form__mail" value="<?php echo $knt['klient_email'];?>" readonly>
                        </div>
                        <div class="col-sm-12">
...
$msg = 'Emri:'.$_POST['name']."\n"
        ...
        mail('info@primecinema.tk', 'PRIEMCINEMA - Kontaktoni', $msg);
...
?> 
        ...
        <section class="container">
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="page-heading">Kontaktet e Kryera</h2>
                        ...
                        <div class="rates-wrapper rates--full">
                            ...
                            <table>
                                ...
                                <thead class="rates rates--top">
                                    <td class="rates__obj"><strong>Emaili</strong></td>
                                    <td class="rates__obj"><strong>Mesazhet</strong></td>
...
<?php $tyu=mysql_query("select * from kontakt where email='$klmeml'")or die (mysql_error());
                while($uio=mysql_fetch_array($tyu)){ ?>
                         <tbody>
                                 <tr class="rates">
                                    <td class="rates__obj"><?php echo $uio['email'];?></td>
                                    <td class="rates__obj"><?php echo $uio['mesazh'];?></td>
