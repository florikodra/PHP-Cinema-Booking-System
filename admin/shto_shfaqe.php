...
<head>
    ...
    <title>PRIME CINEMA - SHTO SHFAQE</title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<?php } ?>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="time" id="text" class="form-control" name="shfaqe_orar" required >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="date" id="text" class="form-control"  name="shfaqe_date" required >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" id="text" class="form-control" placeholder="Leke:" name="shfaqe_cmim" required >
                                    </div>
                                </div>
						...
						$shfaqe_status=$_POST['shfaqe_status'];
                            ...
                            mysql_query("insert into shfaqe(film_id,salle_id,shfaqe_orar,shfaqe_date,shfaqe_cmim,shfaqe_status) values ('$film_id','$salle_id','$shfaqe_orar','$shfaqe_date','$shfaqe_cmim','$shfaqe_status')");
                            
                            ?> <script>
	 window.location='shto_shfaqe.php';
	 </script><?php
                            }
                            ?>
                            </form>
